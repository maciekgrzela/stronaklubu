...
(function($) {
    ...
    var getMonthHtml = function(month, events) {
        ...
        $('.calendar-actions', header).append('<button type="button" class="prev btn btn-link text-white d-inline-flex"><ion-icon name="arrow-back-outline"></ion-icon></button> ');
        $('.calendar-actions', header).append('<button type="button" class="next btn btn-link text-white d-inline-flex"><ion-icon name="arrow-forward-outline"></ion-icon></button> ');
        $('.calendar-actions', header).append('<button type="button" class="today btn btn-link text-white d-inline-flex"><ion-icon name="today-outline"></ion-icon></button> ');
        ...
        for(var i = 0; i < 7; i++) {
            $('.days-container', weekHeader).append('<div class="day ' + moment().locale('PL').day(i).format('dddd').toLowerCase() + '">' + moment().locale('PL').day(i).format('dddd') + '</div>');
        }
