    ...
    function Seatchart(options) {
        ...
        */
        ...
        var createFrontHeader = function createFrontHeader() {
            ...
            front.textContent = 'Płyta boiska';
        ...
        var createCartTotal = function createCartTotal() {
            ...
            cartTotal = createSmallTitle('Całkowita kwota {0}{1}'.format(options.cart.currency, self.getTotal()));
        ...
        var createLegend = function createLegend() {
            ...
            seatsList.appendChild(createLegendItem('Miejsce zajęte', 'unavailable'));
