...
<main role="main" class="container bg-white mb-4 pb-4">
    <div class="row">
        <div class="col-md-12 blog-main events-main">
            ...
            <div class="stadium-map tickets-container text-center">
                <p class="text-left mb-2 tickets-info"></p>
                <div class="row">
                    <div class="col-md-12">
                        <div id="tickets-map" class="d-flex">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="row align-items-baseline">
                            <div class="col-4"><div id="cart-container" class="mt-5"></div></div>
                            <div class="col-4"><div id="legend-container" class="mt-5"></div></div>
                        </div>
                        <div class="row text-right">
                            <div class="col-12 buy-tickets">
                            </div>
                        </div>
                    </div>
                </div>
