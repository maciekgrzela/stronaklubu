$(document).ready(function () {
    ...
    $("#btnAddNarrative").click( function(e) {
        e.preventDefault();
            ...
            $.ajax({
                url : "http://localhost/PSIMv2/backend/api/narratives/create.php",
                method : "post",
                dataType : "json",
                data : {
                    match_ID: matchID,
    ...
    $("#btnDeleteNarrative").click( function(e) {
        ...
        $.ajax({
            url : "http://localhost/PSIMv2/backend/api/narratives/delete.php",
            method : "post",
            dataType : "json",
            data : {
    ...
    $( '#btnEditNarrative' ).click( function(e) {
        ...
        $.ajax({
            url : "http://localhost/PSIMv2/backend/api/narratives/update.php",
            method : "post",
            dataType : "json",
            data : {
                narrative_ID: narrartiveID,
